...
require('util').inherits(imageStreamer, require('stream'));

imageStreamer.prototype.write = function(chunk) {
...
imageStreamer.prototype.end = function(chunk) {
    this.writable = false;
};

imageStreamer.prototype.destroy = function() {
    this.writable = false;
};

module.exports = imageStreamer;